...
Stay Safe. Stay Secure. Stay Ahead with SIFU.
            ...
            <Link href="/early-access" className={cn(buttonVariants({ size: "lg" }))}>
              Get Early Access
            </Link>
            <Link
      ...
      <section id="open-source" className="container py-12 md:py-12 lg:py-24">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-centear my-16">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            BlockSec is open source and powered by open source software. <br />{" "}
            The code is available on{" "}
            <Link
              href={"https://github.com/RishiGitH/Solana_Detector"}
              target="_blank"
              rel="noreferrer"
