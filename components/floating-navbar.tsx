    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <div className="md:hidden block flex w-full justify-between items-center">
          <div
            className={cn(
              "flex max-w-fit space-x-4 mt-4 fixed top-0 inset-x-0 mx-auto border border-transparent dark:border-white/[0.2] rounded-full bg-background shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-[5000] pr-2 pl-8 py-2  items-center justify-center space-x-4",
              className
            )}
          >
